    ...
    <div className="p-6 bg-slate-50 min-h-screen space-y-6 text-slate-800">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-brand hover:bg-brand/90 text-white font-medium text-xs px-4 py-2.5 rounded-lg shadow transition-all"
        >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 p-4">
          <div className="w-full max-w-lg bg-white rounded-xl shadow-2xl">
            ...
            <div className="px-6 pb-6 flex gap-3">
              ...
              <button onClick={handleGenerate} disabled={generating} className="flex-1 py-2 text-xs font-semibold text-white bg-brand hover:bg-brand/90 rounded-md shadow-sm transition">
                ...
                <div>
                  ...
                  {detail.status !== 'Draft' && detail.status !== 'Paid' && (
                    <div className="flex gap-2">
                      ...
                      <button onClick={handleAllocate} disabled={actioning} className="px-3 py-2 text-xs font-bold bg-brand hover:bg-brand/90 text-white rounded">Allocate</button>
                    </div>
                  )}
                </div>
                ...
                <div>
                  ...
                  {detail.status !== 'Draft' && (
                    <div className="flex gap-2">
                      ...
                      <button onClick={handleAddNote} disabled={actioning} className="px-3 py-2 text-xs font-bold bg-brand hover:bg-brand/90 text-white rounded">Add</button>
                    </div>
                  )}
                </div>
              </div>
